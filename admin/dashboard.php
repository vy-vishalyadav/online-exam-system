...
<div class="row g-3 mb-4">
        ...
        <div class="card stat-card bg-gradient-green">
            <div class="card-body d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <h2 class="fw-bold mb-0"><?php echo $total_exams; ?></h2>
                </div>
    ...
    <div class="col-md-4">
        <div class="card stat-card bg-gradient-orange">
            <div class="card-body d-flex justify-content-between align-items-center">
                <div>
                    <h6 class="mb-1">Total Results</h6>
                    <h2 class="fw-bold mb-0"><?php echo $total_results; ?></h2>
                </div>
        ...
        <a href="add-question.php" class="text-decoration-none">
            <div class="card shadow-sm h-100">
                <div class="card-body text-center">
                    ...
                    <h6 class="mt-2 mb-0">Add Question</h6>
                </div>
            </div>
        </a>
    </div>
        ...
        <a href="manage-exam.php" class="text-decoration-none">
            <div class="card shadow-sm h-100">
                <div class="card-body text-center">
                    ...
                    <h6 class="mt-2 mb-0">Manage Exams</h6>
                </div>
            </div>
        </a>
    </div>
        ...
        <a href="view-results.php" class="text-decoration-none">
            <div class="card shadow-sm h-100">
                <div class="card-body text-center">
                    ...
                    <h6 class="mt-2 mb-0">View Results</h6>
                </div>
            </div>
        </a>
    </div>
