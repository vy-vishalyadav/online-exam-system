 ...
 * Strictly protected: Requires Admin Authentication and CSRF validation via POST.
 */
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mb-0 small">
                Verify and apply necessary database schema updates, tables, and performance indexes.
            </p>
        </div>
        ...
        <div class="card border-0 shadow-sm rounded-4 mb-4">
            ...
            <div class="card-body p-4">
                ...
                <ul class="list-group list-group-flush border rounded-3 mb-3 small">
                    <?php foreach ($migration_results as $msg): ?>
        ...
        <div class="card border-0 shadow-sm rounded-4">
            <div class="card-body p-4">
                <div class="alert alert-info border-0 rounded-3 mb-4 small">
                    ...
                    <strong>When to run:</strong> Run this once after uploading the site files to InfinityFree or whenever the database schema is updated. It will verify all tables, columns, foreign keys, and indexes idempotently without affecting existing exams or students.
                </div>
                ...
                <form method="POST" action="migrate.php">
                    ...
                    <div class="p-3 bg-light rounded-3 border mb-4">
                        ...
                        <ul class="text-muted small mb-0 ps-3">
                            <li>Admin session active: <strong>Yes (Logged in as Admin)</strong></li>
